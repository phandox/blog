...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "docker_single_host", primary: true do |docker_single_host|
    ...
    docker_single_host.vm.network "forwarded_port", guest: 8800, host: 8080, host_ip: "127.0.0.1"
    docker_single_host.vm.network "forwarded_port", guest: 8081, host: 8081, host_ip: "127.0.0.1"
