...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "manual_web", primary: true do |manual_web|
    manual_web.vm.box = "centos/7"
    manual_web.vm.box_check_update = false
    manual_web.vm.network "forwarded_port", guest: 80, host: 8080, host_ip: "127.0.0.1"
  end
